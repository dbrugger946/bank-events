 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__746FB059_450238_454996_459009_4528DB94C559AF;
...
public class PersonalizationResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_746FB059-0238-4996-9009-28DB94C559AF", "Personalization");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_746FB059-0238-4996-9009-28DB94C559AF", "Personalization", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Personalization") + ".dmn_nologic")));
    }
